      ...
      <body>
        <main className="min-h-screen bg-black text-gray-100 font-mono flex items-center justify-center p-6">
          <div className="w-full max-w-lg rounded-lg border border-gray-800 bg-gray-900 p-6">
            <h1 className="text-xl font-bold mb-2">Alkalmazáshiba</h1>
            <p className="text-sm text-gray-400 mb-2">Alkalmazásszintű hiba történt.</p>
            <p className="text-xs text-gray-500 mb-4 break-all">{error.message}</p>
